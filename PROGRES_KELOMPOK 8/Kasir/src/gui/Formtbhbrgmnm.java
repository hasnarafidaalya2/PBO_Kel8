...
public class Formtbhbrgmnm extends javax.swing.JFrame {
    private ServiceMinuman sm;

    public Formtbhbrgmnm() {
        initComponents();
        try {
            sm = new DaoMinuman();
            loadData();
    ...
    Formtbhbrgmnm(formkasir aThis, boolean b) {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Tambah Produk Minuman");
        ...
        jLabel5.setText("Nomor Izin Minuman");
...
//        }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Formtbhbrgmnm().setVisible(true);
            }
        });
    }
